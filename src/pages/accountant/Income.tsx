      ...
      <div className="flex-1 min-w-0">
        ...
        <main className="px-5 lg:px-8 py-6 space-y-6 max-w-[1400px]">
          ...
          <section className="animate-rise flex items-start justify-between flex-wrap gap-3">
            <div>
              <h1 className="font-display text-base font-semibold text-ink">Income Management</h1>
              <p className="text-xs text-muted mt-0.5">Track, filter, and reconcile every income record against its source and category</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="relative lg:col-span-2">
                ...
                <input
                  ...
                  placeholder="Search description, client, reference, invoice…"
                  value={search}
                  onChange={(e) => {
              ...
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-line">
                    ...
                    <th className="px-5 py-2.5 text-[11px] font-medium uppercase tracking-wide text-muted">Client</th>
                    <th className="px-5 py-2.5 text-[11px] font-medium uppercase tracking-wide text-muted">Payment</th>
                    <th className="px-5 py-2.5 text-[11px] font-medium uppercase tracking-wide text-muted">Invoice</th>
          ...
          <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-card rounded-xl border border-line shadow-panel">
            <div className="px-6 py-4 border-b border-line flex items-center justify-between">
              <h2 className="font-display text-base font-semibold text-ink">
                {editingId ? 'Edit Income Record' : 'Add Income Record'}
              </h2>
      ...
      {pendingDeleteId && (
        <div className="fixed inset-0 z-50 bg-ink/40 flex items-center justify-center p-4">
          <div className="w-full max-w-sm bg-card rounded-xl border border-line shadow-panel p-6">
            <h2 className="font-display text-base font-semibold text-ink">Delete income record?</h2>
